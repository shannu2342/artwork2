...
const ADMIN_FLASH_KEY = 'adminAuthFlashMessage';
...
export const getAdminFlashMessage = () => localStorage.getItem(ADMIN_FLASH_KEY) || '';
export const clearAdminFlashMessage = () => localStorage.removeItem(ADMIN_FLASH_KEY);
...
export const notifyAdminSessionExpired = () => {
    clearAdminSession();
    if (typeof window !== 'undefined') {
        localStorage.setItem(ADMIN_FLASH_KEY, 'Session expired. Please login again.');
