...
const FloatingWhatsApp = ({ organizationName = 'Limitless Art Org', whatsappNumber = '919654168888' }) => {
    const [open, setOpen] = useState(false);
    const safeWhatsappNumber = normalizeWhatsappNumber(whatsappNumber);
    const whatsappUrl = `https://wa.me/${safeWhatsappNumber}?text=${encodeURIComponent(DEFAULT_MESSAGE)}`;
                    ...
                    <div className="bg-[#0f766e] px-4 py-3 text-white flex items-center justify-between">
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                                <p className="font-bold leading-tight truncate">{organizationName}</p>
