            ...
            <footer className="bg-gradient-to-b from-[#2C3E50] to-[#1a252f] text-white py-16 text-center md:text-left relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8">
                        <div>
                            <div className="flex items-center justify-center md:justify-start mb-6">
                                ...
                                <span className="text-2xl font-black text-[#D4AF37] tracking-wider">{site.organizationName}</span>
                            </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-300 flex items-center justify-center md:justify-start gap-2"><Phone className="w-4 h-4 text-[#D4AF37]" /> {contact.phone}</p>
                            <p className="text-gray-300 flex items-center justify-center md:justify-start gap-2 mt-2"><Mail className="w-4 h-4 text-[#D4AF37]" /> {contact.email}</p>
                            <div className="mt-5 flex items-center justify-center md:justify-start gap-3">
                                {social.instagramUrl ? (
                                    <a
                                        ...
                                        className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition hover:bg-[#D4AF37] hover:text-[#1a252f]"
                                    >
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400">
                        <p>&copy; {new Date().getFullYear()} {site.organizationName}. All rights reserved.</p>
                    </div>
                </div>
            </footer>

            <FloatingWhatsApp organizationName={site.organizationName} whatsappNumber={contact.whatsappNumber} />
        </div>
    );
};
