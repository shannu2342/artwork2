...
export const defaultSiteContent = {
    site: {
        organizationName: 'Limitless Art',
        contact: {
            email: 'limitlessart.org@gmail.com',
            phone: '+91 96541 68888',
            whatsappNumber: '919654168888',
            address: 'Delhi NCR, India'
        },
        social: {
            instagramUrl: 'https://instagram.com/limitlessart_org',
            youtubeUrl: 'https://youtube.com/@limitlessart'
        },
        seo: {
            siteUrl: 'https://limitlessart.org',
            defaultTitle: 'Limitless Art | Empowering Specially-Abled Children Through Art',
            defaultDescription:
                'Limitless Art empowers specially-abled children through inclusive art workshops, skill development programs, emotional support, and creative learning.',
            keywords:
                'Limitless Art, specially-abled children, inclusive art workshops, art education, disability support, creative learning, India',
            ogImage: '/logo.jpg',
            homeTitle: 'Limitless Art | Inclusive Art Workshops And Skill Development',
            homeDescription:
                'Explore inclusive art workshops, mentor-led learning, and confidence-building programs for specially-abled children at Limitless Art.',
            contactTitle: 'Contact Limitless Art | Workshops, Registration And Support',
            contactDescription:
                'Contact Limitless Art for workshop details, registration support, partnerships, and parent enquiries.',
            registrationTitle: 'Register With Limitless Art | Join Our Workshops',
            registrationDescription:
                'Register your child for inclusive art and skill development programs at Limitless Art.'
        }
    },
    home: {
        hero: {
        ...
        whoWeAre: {
            ...
            videoTitle: 'See Limitless Art In Action',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            videoDescription: 'Use this space to share your story, workshop walkthrough, founder message, or a short impact video that helps families understand the mission quickly.'
        },
        highlights: [
        ...
        gallery: {
            ...
            pageTitle: 'Gallery Collection',
            pageDescription: 'Browse the full collection of artwork, workshop memories, and creative milestones from our students.',
            items: [
                { mediaType: 'image', image: 'https://picsum.photos/seed/51/600/400', video: '', title: 'Student Art #1', subtitle: 'View Masterpiece' },
                { mediaType: 'image', image: 'https://picsum.photos/seed/52/600/400', video: '', title: 'Student Art #2', subtitle: 'View Masterpiece' },
                { mediaType: 'image', image: 'https://picsum.photos/seed/53/600/400', video: '', title: 'Student Art #3', subtitle: 'View Masterpiece' },
                { mediaType: 'image', image: 'https://picsum.photos/seed/54/600/400', video: '', title: 'Student Art #4', subtitle: 'View Masterpiece' },
                { mediaType: 'image', image: 'https://picsum.photos/seed/55/600/400', video: '', title: 'Student Art #5', subtitle: 'View Masterpiece' },
                { mediaType: 'image', image: 'https://picsum.photos/seed/56/600/400', video: '', title: 'Student Art #6', subtitle: 'View Masterpiece' }
            ]
        },
        workshops: {
