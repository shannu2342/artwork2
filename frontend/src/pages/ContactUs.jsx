...
const ContactUs = () => {
    ...
    const phoneHref = normalizeNumericLink(contact.phone);
    const whatsappHref = normalizeNumericLink(contact.whatsappNumber);

    return (
        <>
            <Seo
                title={site.seo.contactTitle || site.seo.defaultTitle}
                description={site.seo.contactDescription || site.seo.defaultDescription}
                ...
                structuredData={{
                    ...
                    '@type': 'ContactPage',
                    name: `${site.organizationName} Contact`,
                    url: `${site.seo.siteUrl.replace(/\/+$/, '')}/contact`,
                    about: site.organizationName
                }}
            />
            <div id="contact-us" className="min-h-[100dvh] bg-gradient-to-br from-[#f8fafc] via-white to-[#fff8df] py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10">
                        <h1 className="text-4xl md:text-5xl font-black text-[#2C3E50]">Contact {site.organizationName}</h1>
                            ...
                            >
                                ...
                                <div className="space-y-5 text-gray-700">
                                    <div>
                                        ...
                                        <p className="text-sm mt-1">Fill the registration form and our coordinator will confirm the next batch.</p>
                                    </div>
                                    <div>
                                ...
                                <div className="space-y-5 text-gray-700">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href={`mailto:${contact.email}`} className="text-sm hover:text-[#D4AF37] break-all">
                                                {contact.email}
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href={`tel:${phoneHref}`} className="text-sm hover:text-[#D4AF37]">
                                                {contact.phone}
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href={`https://wa.me/${whatsappHref}`} target="_blank" rel="noreferrer" className="text-sm hover:text-[#D4AF37]">
